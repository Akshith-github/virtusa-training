...
const research = [
    {
        ...
        authors : "Nukala Akshith, Mr.R Raja Subramanian, Gogula Narshima Murthy, Manchala Vikas, Karnam Balaji, Srikar Amara",
        conferences : "Confluence-2021:11th International Conference on Cloud Computing, Data Science & Engineering",
        researchYr : 2021,
        citebox : "popup1",
        image : "assets/images/research-page/sentiment analysis2.jpg",
        citation: {
            vancouver: " Mr.R Raja Subramanian, Nukala Akshith, Gogula Narshima Murthy, Manchala Vikas, Karnam Balaji and Srikar Amara. A Survey on Sentiment Analysis. 11th International Conference on Cloud Computing, Data Science & Engineering.Confluence-2021."
        },
        abstract: "Sentiment analysis is one of the recent \
        technologies under NLP (an application of AI and ML).\
        Sentiment analysis is used in many applications for\
        recommendation and feedback analysis. In this paper, from\
        defining the sentiment analysis to algorithms for sentiment\
        analysis and from the first step of sentiment analysis to\
        evaluating the predictions of sentiment classifiers, additional\
        feature extractions to boost performance are discussed with\
        practical results. A brief description of complex sequencebased Neural Network sentiment classifiers with reasonable\
        analytics is provided. The practical results declared in this\
        paper are from the implantation of sentiment analysis on the\
        IMDB movie reviews dataset. Evaluation metrics such as\
        accuracy, precision, recall, and f1-score are used. This\
        Research-based survey has been divided into different\
        sections, each section concerning the stepwise process of\
        sentiment analysis. ",
        absbox: "absPopup1"
    },
    {
        title : "A paper on Computer vision based weed identification ",
        authors : "Harini mohan, Nukala Akshith",
        conferences : "Not yet confirmed",
        researchYr : 2021,
        citebox : "popup2",
        image : "assets/images/research-page/weed_opencv.jpg",
        citation: {
            vancouver: "Harini mohan and Nukala Akshith. Paper is under work ."
        },
        abstract: "Paper is UnderWork,Stay tuned.",
        absbox: "absPopup2"
    },
    {
        title : "A paper on Reinforcement Learning",
        authors : "Achuth Dintakurthi and Nukala Akshith",
        conferences : "Not yet Confirmed",
        researchYr : 2021,
        citebox : "popup3",
        image : "assets/images/research-page/reinforcement.jpg",
        citation: {
            vancouver: "Achuth Dintakurthi and Nukala Akshith. A paper on Reinforcement Learning. stay tuned for our amazing works"
        },
        abstract: "Paper is UnderWork,Stay tuned.",
        absbox: "absPopup3"
    }
