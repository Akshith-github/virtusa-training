...
<footer class="webintern-footer">
    <div class="footer-left">
      ...
      <a href="https://www.linkedin.com/in/nukala-akshith-642b641a5/" class="linkedin sub-footer-icon">
          <i class="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/Akshith-github" class="git sub-footer-icon">
          <i class="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/Akshithk13" class="twitter sub-footer-icon">
          <i class="fab fa-twitter"></i>
        </a>
        <a href="#" class="email-icon sub-footer-icon" >
        <i id="mail" class="fa fa-envelope" ></i>
        </a>
        <a href="https://www.kaggle.com/nakshith" class="kaggle sub-footer-icon" >
